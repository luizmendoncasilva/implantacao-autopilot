/*
  Ícones inline (estilo lucide — mesmo conjunto usado em RegrasGeraisPage.jsx /
  EmpresaDetalhe.jsx), sem dependência externa. Uso: Icon("chevron-right", "size-4").
*/
(function (global) {
  const PATHS = {
  ...
  function Icon(name, className) {
    const inner = PATHS[name] || PATHS["circle-check"];
    return (
